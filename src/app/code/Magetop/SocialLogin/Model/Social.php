...
namespace Magetop\SocialLogin\Model;
 ...
 * Class Social
 *
 * @package Magetop\SocialLogin\Model
 */
class Social extends AbstractModel
{
     ...
     * @param \Magetop\SocialLogin\Helper\Social $apiHelper
    ...
    public function __construct(
        ...
        \Magetop\SocialLogin\Helper\Social $apiHelper,
    ...
    {
        $this->_init('Magetop\SocialLogin\Model\ResourceModel\Social');
    }
