...
class Social extends HelperData
{
    ...
    public function getSocialConfig($type)
    {
        $apiData = [
            ...
            'Vkontakte' => ['wrapper' => ['class' => '\Magetop\SocialLogin\Model\Providers\Vkontakte']],
            'Instagram' => ['wrapper' => ['class' => '\Magetop\SocialLogin\Model\Providers\Instagram']],
            'Github'    => ['wrapper' => ['class' => '\Magetop\SocialLogin\Model\Providers\GitHub']],
            'Amazon'    => ['wrapper' => ['class' => '\Magetop\SocialLogin\Model\Providers\Amazon']],
