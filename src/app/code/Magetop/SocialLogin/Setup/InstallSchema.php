...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('magetop_social_customer')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('magetop_social_customer'))
                ...
                ->addForeignKey(
                    $installer->getFkName('magetop_social_customer', 'customer_id', 'customer_entity', 'entity_id'),
                    'customer_id',
